/*Write an OpenCL program which reads a string as character input and toggles every character of this string in parallel. 
Store the resultant string in another character array. Also find the execution time taken by the kernel*/
